...
def take_input(DOGDATADIRe, CATDATADIRe):
    ...
    try:
        ...
        dog_data1 = np.asanyarray(dog_arr)
        cat_data1 = np.asanyarray(cat_arr)
        dog_data1 = np.expand_dims(dog_data, axis=4)
        cat_data1 = np.expand_dims(cat_data, axis=4)
